...
- [ ] T01 FR-001: the rule in the GM's words - constitution XII "CITE ONLY WHAT CAN BE READ" (v2.19.0, the SUMMARY-ONLY citation clauses struck), root CLAUDE.md research bullet, research/CLAUDE.md quote + link sections
      research: rendering
- [ ] T02 FR-003 / FR-004: quote-check gains the READABLE / NOT-READABLE verdict and the "cannot land as a citation" rule; its stale Markdown Input paragraph fixed (XIV); source-reader's SUMMARY-ONLY = not citable
      research: rendering
