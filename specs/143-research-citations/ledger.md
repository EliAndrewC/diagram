...
| 4 | `research/cities/capitals.md` "Street widths" (and `s.road`'s 26 ft default) | 26 ft is "the Tōkaidō's own width" | ja.wikipedia 東海道 (READ): the 1604 standard was 5 ken ≈ 9 m ≈ 29.5 ft; the 13.8 m Honchō-dōri peg not found (9.9-11.8 m seen) | `s.road` default `lw(26)` on every Mode B map; the 45 ft ōte-suji as "half again the highway" | **GM 2026-08-28: raise the default to ~30 ft on every Mode B map** - done as feature 144 (`ROAD_W_FT`). |
