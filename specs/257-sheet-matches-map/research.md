...
- The set-apart shrine's own well is placed on rings of 54, 66, 80, 96 and 112 map px around the
  ...
  Hoshigaoka map it landed on the first ring due north, at map (392, 1020).
...
only possible if (x, y) is the center. The map's `meta.ftpx` gives its scale.
...
map's own render (2026-09-20):**

- the shrine hall, 60 by 48 ft, its long side east-west, facing south;
...
**Decision.** The redrawn sheet (spec FR-006) shows the hall at 60 by 48 ft, the arch 20 ft in front
