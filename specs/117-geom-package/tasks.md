...
- [x] T027 Stop-work procedure: commit in the clone, then `scripts/sync-with-main.sh done`. NOT run on a
      ...
      **DONE** 2026-08-17. The push's pull auto-merged feature 118's (`rolling/`) edits into
      `settlement/CLAUDE.md`, which my commits also touched, so the procedure's fix-forward branch
