...
## R8 - Amendment 2: the GM's answer (FR-012 to FR-014)
...
the tier test carries that one exception by name with the measurement and the approval as its reason, failing on a stale row
...
**A wording correction (2026-09-20, after landing).** R8 and the records around it said `spec-fidelity`'s exception,
the fidelity-contract change and the two watched agents rested on "the GM's ruling". The GM asked what that meant:
*"I don't recall ruling that spec-fidelity should keep the CLAUDE.md files. I don't object, but do you mean my
ruling in terms of me saying to go with your recommendation?"* It does - the session measured, recommended, and the
GM answered *"go with your recommendations to all three"*; they did not raise any of the three questions or decide
one independently. The phrase overstated that, and it was load-bearing in one place: `KEEPS_CLAUDE_MD`'s comment
says an entry there is never a session's convenience, and "the GM's ruling" set that bar somewhere the GM had not
been. Every occurrence now says what happened - a measurement, a recommendation and an approval - and the exception
row quotes all three. The GM's ruling of 2026-09-19, that defined subagents should not be handed these files at all,
is theirs and is still described as such.
