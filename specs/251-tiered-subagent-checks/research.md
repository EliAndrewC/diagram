...
| `source-reader` sonnet / high, harder contract | 08-29 | the paper again unreachable (SUMMARY-ONLY after five hosts, against the contract's own three-URL bound); **no CONTRADICTED this time** - the recorded finding MISSED | 15 -> 32 | 0.28 -> 0.62 |
| `source-reader` sonnet / high, harder contract | 09-12 (clean) | the 5-10 m width **MISSED a third time**; "built separately" now quoted as a partial READ, as the contract asked | 7 -> 7 | 0.92 -> 0.16 |
