...
- Work is done in the session clone on `main` (session-clone workflow); the spec-kit git feature-branch hook is intentionally not used because it conflicts with the push-back-to-`main` procedure.
