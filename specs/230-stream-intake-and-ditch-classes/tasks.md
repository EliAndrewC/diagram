...
- [ ] T07 settlement-review pass 10's findings, each fixed and verified on a regenerated pool (the reviews read the snapshot taken before the lane-ink, sawtooth-nudge and drain-hue fixes)
      ...
      - [ ] OPEN with measurements (future-work/farming-communities.md): Inashiro's windbreak limb; Mizuguchi's drain hook; the brook's ruled reach where the field's margin is straight; the flooded-plot lip, the 4.8 ft field chain, Kuwabata's reversed supply tapers and the fan floor's invisible spike (all also on main)
