...
**Sources (feature 143, 2026-08-28):** a check audit - rendering and gate coverage, nothing physical asserted; the doctrine holes it names are grounded where each rule lives (`research/towns.html`, `research/urban-features.html`).
