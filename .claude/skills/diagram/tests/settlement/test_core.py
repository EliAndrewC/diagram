...
def test_build_comb_supply_banks_hems_bunds_onto_the_channel_banks():
    ...
    net = build_comb(1300, 1700, (520, 220), full_or(3, 5), supply_banks=True, **kw)  # a 3-fan comb (T19: the 5-fan one cost 2.3 s and proved the same clearance)
    ...
    assert buried_corners(build_comb(1300, 1700, (520, 220), full_or(3, 5), **kw), -0.15) > 0
