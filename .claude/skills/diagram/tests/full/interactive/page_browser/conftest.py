...
<p>The kainyo of the Tonami plain is a stand of sugi,<sup class="fn"><a id="fnref-1" href="#fn-1">1</a></sup> and <code>yashikirin</code> is the name.<sup class="fn"><a id="fnref-2" href="citations/record.html#fn-2">2</a></sup></p>
