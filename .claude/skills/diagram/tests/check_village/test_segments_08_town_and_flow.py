...
def test_marsh_on_low_ground_fires_when_marsh_is_uphill():
    ...
    assert "marsh_on_low_ground" in f_only(M, "marsh_on_low_ground")
...
def test_drain_flows_downhill_fires_when_outfall_is_uphill():
    ...
    assert "drain_flows_downhill" in f_only(_drain([[300, 300], [700, 700]], stream=[[300, 300], [40, 40]]), "drain_flows_downhill")


def test_drain_flows_downhill_passes_when_outfall_is_downhill():
    assert "drain_flows_downhill" not in f_only(_drain([[300, 300], [700, 700]], stream=[[700, 700], [950, 950]]), "drain_flows_downhill")
...
def test_drain_flows_downhill_defaults_to_the_lower_end_with_no_brook():
    ...
    assert "drain_flows_downhill" not in f_only(_drain([[300, 300], [700, 700]]), "drain_flows_downhill")
...
def test_drainage_discharges_downhill_fires_when_the_brook_runs_uphill():
    ...
    assert "drainage_discharges_downhill" in f_only(_drain([[300, 300], [700, 700]], stream=[[700, 700], [400, 400]]), "drainage_discharges_downhill")
...
def test_drainage_junction_smooth_fires_on_a_hard_corner():
    ...
    assert "drainage_junction_smooth" in f_only(M, "drainage_junction_smooth")
...
def test_drainage_junction_smooth_passes_when_the_brook_curves_out():
    ...
    assert "drainage_junction_smooth" not in f_only(M, "drainage_junction_smooth")
...
def test_drain_runs_cross_slope_fires_when_it_runs_downhill():
    ...
    assert "drain_runs_cross_slope" in f_only(_drain([[300, 300], [700, 700]]), "drain_runs_cross_slope")
...
def test_drain_runs_cross_slope_passes_for_a_contour_collector():
    ...
    assert "drain_runs_cross_slope" not in f_only(_drain([[300, 700], [700, 300]]), "drain_runs_cross_slope")
...
def test_paddy_bunds_clear_the_collector_fires_on_a_bund_drawn_across_the_ditch():
    ...
    assert "paddy_bunds_clear_the_collector" in f_only(_hem_M([[480, 480], [520, 440], [560, 480], [520, 520]]), "paddy_bunds_clear_the_collector")
...
def test_paddy_bunds_clear_the_collector_fires_on_a_bund_inside_the_ditchs_stroke():
    ...
    assert "paddy_bunds_clear_the_collector" in f_only(_hem_M([[440, 440], [480, 400], [520, 479], [480, 519]]), "paddy_bunds_clear_the_collector")
...
def test_paddy_bunds_clear_the_collector_passes_when_the_field_hems_onto_the_bank():
    ...
    assert "paddy_bunds_clear_the_collector" not in f_only(_hem_M([[440, 440], [480, 400], [500, 460], [460, 500]]), "paddy_bunds_clear_the_collector")
...
def test_paddy_bunds_clear_the_collector_skips_ground_past_the_collectors_ends():
    ...
    assert "paddy_bunds_clear_the_collector" not in f_only(_hem_M([[760, 240], [800, 280], [760, 320], [720, 280]]), "paddy_bunds_clear_the_collector")
...
def test_paddy_bunds_clear_the_collector_skips_a_field_with_no_recorded_hem():
    ...
    assert "paddy_bunds_clear_the_collector" not in f_only(M, "paddy_bunds_clear_the_collector")
...
def test_paddy_bunds_clear_the_supply_channels_fires_on_a_bund_down_the_channels_centerline():
    ...
    assert "paddy_bunds_clear_the_supply_channels" in f_only(_sup_M([[500, 300], [500, 400], [540, 400], [540, 300]]), "paddy_bunds_clear_the_supply_channels")
...
def test_paddy_bunds_clear_the_supply_channels_fires_on_a_bund_inside_the_stroke():
    ...
    assert "paddy_bunds_clear_the_supply_channels" in f_only(_sup_M([[503, 300], [503, 400], [540, 400], [540, 300]]), "paddy_bunds_clear_the_supply_channels")
...
def test_paddy_bunds_clear_the_supply_channels_fires_on_a_branch_ditch_too():
    ...
    assert "paddy_bunds_clear_the_supply_channels" in f_only(_sup_M([[500, 300], [500, 400], [540, 400], [540, 300]], role="branch"), "paddy_bunds_clear_the_supply_channels")
...
def test_paddy_bunds_clear_the_supply_channels_passes_when_the_bund_sits_on_the_bank():
    ...
    assert "paddy_bunds_clear_the_supply_channels" not in f_only(_sup_M([[505.5, 300], [505.5, 400], [540, 400], [540, 300]]), "paddy_bunds_clear_the_supply_channels")
...
def test_paddy_bunds_clear_the_supply_channels_fires_on_an_edge_through_the_water_with_dry_corners():
    ...
    assert "paddy_bunds_clear_the_supply_channels" in f_only(_sup_M([[498, 150], [502, 150], [502, 850], [498, 850]]), "paddy_bunds_clear_the_supply_channels")
...
def test_paddy_bunds_clear_the_supply_channels_skips_ground_past_the_strokes_ends():
    ...
    assert "paddy_bunds_clear_the_supply_channels" not in f_only(_sup_M([[500, 803], [503, 804], [540, 850], [540, 900]]), "paddy_bunds_clear_the_supply_channels")
...
def test_paddy_bunds_clear_the_supply_channels_does_not_govern_the_drain():
    ...
    assert "paddy_bunds_clear_the_supply_channels" not in f_only(_sup_M([[500, 300], [500, 400], [540, 400], [540, 300]], role="drain"), "paddy_bunds_clear_the_supply_channels")
...
def test_paddy_bunds_clear_the_supply_channels_skips_legacy_maps():
    ...
    assert "paddy_bunds_clear_the_supply_channels" not in f_only(_sup_M([[500, 300], [500, 400], [540, 400], [540, 300]], gen=None), "paddy_bunds_clear_the_supply_channels")
...
def test_paddy_bunds_clear_the_supply_channels_skips_a_field_with_no_recorded_rings():
    ...
    assert "paddy_bunds_clear_the_supply_channels" not in f_only(M, "paddy_bunds_clear_the_supply_channels")
...
def test_paddy_bunds_clear_the_supply_channels_skips_a_degenerate_ditch_record():
    ...
    assert "paddy_bunds_clear_the_supply_channels" not in f_only(
        _sup_M([[500, 300], [500, 400], [540, 400], [540, 300]], ditch={"poly": [[500, 200]], "role": "main", "field": "f", "w": 8.0}), "paddy_bunds_clear_the_supply_channels"
    )
...
def test_pond_connected_to_field_fires_when_a_drainage_pond_drain_stops_short():
    ...
    assert "pond_connected_to_field" in f_only(M, "pond_connected_to_field")
...
def test_pond_connected_to_field_passes_when_the_drain_reaches_the_drainage_pond():
    ...
    assert "pond_connected_to_field" not in f_only(M, "pond_connected_to_field")
...
def test_pond_clear_of_field_fires_when_the_pond_sits_on_the_paddies():
    ...
    assert "pond_clear_of_field" in f_only(M, "pond_clear_of_field")
