...
- windbreak: **19** clumps drawn, **13** off the page
- copse: **38** clumps drawn
- farmhouses: **16**
- farmstead fixtures: bath **6**, coop **11**, pit **5**, privy **10**, woodpile **13**
- notice board at **(2120.4, 448.9)**, **10** of 16 farmhouses within 250 ft
<!-- /census -->
...
## 2026-09-12 (feature 227): the homesteads seated envelope first - the layout moved
  ...
  On this map: 16 of 16 seated on the first roll, 58 placer calls at 5.1 rectangles each (37 rectangles judged per
  house against 387 under feature 226), 3.6 candidates per house; the front row seated 0 and the
  ranks behind ran 4 rounds; the front row seats nothing on the dike heads and the ranks seat everything from the cloud in four rounds; the round shape drawn at 2.4 against its 2.0 (1.71 before the rank ends were offered). The review of the re-pack follows.
