...
- windbreak: **34** clumps drawn, **63** off the page
- copse: **95** clumps drawn
- farmhouses: **16**
- farmstead fixtures: bath **6**, coop **9**, pit **6**, privy **12**, shrine **1**, woodpile **11**
- notice board at **(2098.9, 469.4)**, **11** of 16 farmhouses within 250 ft
<!-- /census -->
...
## 2026-09-12 (feature 227): the homesteads seated envelope first - the layout moved
  ...
  On this map: 16 of 16 seated (roll attempt 1), 35 placer calls at 4.2 envelope tests each,
  18 rectangle tests per house counting every test against 387 under feature 226, 2.2 candidates per house;
  the front row seated 2 and the ranks behind ran 5 rounds; the nearest house stands 118 px from the field
  outline with 5 within 165; drawn aspect 2.02 - the dike heads offer two front seats and the rest of the cluster comes from the ranks and the rescue; the houses stand behind the dike's bank with their yards to it, and the windbreak seats few clumps where they now stand - the review's second pass judges it; windbreak 34 clumps, copse 95; 3 of
  16 gardens split. The review of the re-pack follows.
