...
- windbreak: **241** clumps drawn, **25** off the page
- copse: **103** clumps drawn
- farmhouses: **20**
- farmstead fixtures: bath **6**, coop **14**, pit **6**, privy **6**, woodpile **13**
- notice board at **(2295.1, 3105.8)**, **5** of 20 farmhouses within 250 ft
<!-- /census -->
...
## 2026-09-12 (feature 227): the homesteads seated envelope first - the layout moved
  ...
  and the two 2 px slides are gone, the front row stands at a computed standoff from its chain, and the ranks
  behind it are proposed behind the standing houses one envelope's depth back (the GM: *"measuring the
  ...
  On this map: 20 of 20 seated on the first roll, 41 placer calls at 4.5 rectangles each (19 rectangles judged per
  house against 220 under feature 226), 2.0 candidates per house; the front row seated 9 and the
  ranks behind ran 2 rounds; the elongated shape drawn at 2.67 against its band's 2.8, recorded unhonored - a direction of travel the GM judges at acceptance. The review of the re-pack follows.
