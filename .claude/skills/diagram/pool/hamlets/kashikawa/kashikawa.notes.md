...
- windbreak: **219** clumps drawn, **41** off the page
- copse: **119** clumps drawn
- farmhouses: **20**
- farmstead fixtures: bath **7**, coop **16**, pit **7**, privy **14**, woodpile **12**
- notice board at **(2415.9, 2970.4)**, **4** of 20 farmhouses within 250 ft
<!-- /census -->
...
## 2026-09-12 (feature 227): the homesteads seated envelope first - the layout moved
  ...
  The homesteads are seated ENVELOPE FIRST now (feature 227, GM 2026-09-12: *"drawing a rectangle around what
  would be within the homestead. And then once we definitely have enough space, we decide things like whether
  the garden is on the left or the right side"*): a placer call tests one rectangle - the box around the
  homestead's configurations - against the site boundary and the placed boxes, then each configuration's own
  box where the union is refused, and lays the parts inside a box the ground admitted; the spiral of offsets
  and the two 2 px slides are gone. The front row stands at a computed standoff from its chain - the wall rule
  and the homestead's core's reach toward the chord, pushed once past an outline that lies beyond it by the
  outline's measured reach and a footpath's room - and the ranks behind are proposed behind the standing houses
  one homestead's depth back, growing along the field only when the back is refused (the GM: *"measuring the
  distance to the neighbor and then moving however much the correct amount is"*). The layout re-packed under
  the same rules; the GM accepted looser packing and set no target for the bed splits.

  On this map: 20 of 20 seated (roll attempt 1), 26 placer calls at 2.8 envelope tests each,
  7 rectangle tests per house counting every test against 220 under feature 226, 1.3 candidates per house;
  the front row seated 9 and the ranks behind ran 2 rounds; the nearest house stands 47 px from the field
  outline with 8 within 165; drawn aspect 2.88 - the elongated shape honored; windbreak 219 clumps, copse 119; 3 of
  20 gardens split. The review of the re-pack follows.
