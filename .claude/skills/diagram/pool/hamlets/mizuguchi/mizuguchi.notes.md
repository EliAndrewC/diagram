...
- windbreak: **172** clumps drawn, **51** off the page
- copse: **32** clumps drawn
- farmhouses: **12**
- farmstead fixtures: bath **5**, coop **10**, pit **6**, privy **9**, woodpile **9**
- notice board at **(830.6, 1971.1)**, **5** of 12 farmhouses within 250 ft
<!-- /census -->
...
water, 0 inside the cluster's hull - before and after; in-view density per 1,000 sq ft blades 10.21 -> 10.27, reeds 5.20 -> 5.34; the
...
## 2026-09-12 (feature 226): the homesteads seated from the site boundary - the layout moved
  ...
  On this map: 12 of 12 seated on the first roll with 2.5 candidates per house (1.1 placer calls) - the
  fewest guesses in the pool. The cluster is a single margin row now rather than a blob with a lane loop; the
  rolled round shape stays unhonored and moved further from its band (2.40 -> 3.72 drawn; feature 220's entry
...
## 2026-09-12 (feature 227): the homesteads seated envelope first - the layout moved
  ...
  On this map: 12 of 12 seated (roll attempt 1), 16 placer calls at 2.2 envelope tests each,
  6 rectangle tests per house counting every test against 113 under feature 226, 1.3 candidates per house;
  the front row seated 6 and the ranks behind ran 2 rounds; the nearest house stands 37 px from the field
  outline with 9 within 165; drawn aspect 2.61 - the round shape drawn over its band, recorded unhonored - the GM judges the shapes at acceptance; windbreak 172 clumps, copse 32; 1 of
  12 gardens split. The review of the re-pack follows.
