...
- windbreak: **135** clumps drawn, **68** off the page
- copse: **29** clumps drawn
- farmhouses: **12**
- farmstead fixtures: bath **4**, coop **5**, pit **5**, privy **8**, woodpile **9**
- notice board at **(911.6, 1769.6)**, **10** of 12 farmhouses within 250 ft
<!-- /census -->
...
## 2026-09-12 (feature 227): the homesteads seated envelope first - the layout moved
  ...
  On this map: 12 of 12 seated on the first roll, 27 placer calls at 4.6 rectangles each (20 rectangles judged per
  house against 113 under feature 226), 2.2 candidates per house; the front row seated 5 and the
  ranks behind ran 2 rounds; the round shape drawn at 2.22 against its 2.0. The review of the re-pack follows.
