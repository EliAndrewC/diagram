...
- farmhouses: **12**
- farmstead fixtures: bath **3**, coop **6**, pit **4**, privy **9**, shrine **1**, woodpile **9**
...
## 2026-09-12 (feature 227): the homesteads seated envelope first - the layout moved
  ...
  homestead to homestead the median gap is 19 px (worst 68) - the fabric is continuous, which a centre-to-centre
