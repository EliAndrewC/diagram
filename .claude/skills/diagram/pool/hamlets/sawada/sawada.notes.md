...
flooded plot is demoted; the belt trim now tests the real page (this map's canopy is in the Census
block below, and its houses beyond the belt's ends went 8 of 19 to 1); and the copse inside the
belt is 0 of 17. **`make jogs` remains red here at 1 step** - see the feature's own record.

**Other counts:** in the Census block below - the hand-typed ones here were a roll stale. Knobs rolled
...
- windbreak: **231** clumps drawn, **29** off the page
- copse: **202** clumps drawn
- farmhouses: **19**
- farmstead fixtures: bath **9**, coop **13**, pit **5**, privy **8**, woodpile **12**
- notice board at **(1802.0, 1846.5)**, **2** of 19 farmhouses within 250 ft
<!-- /census -->
...
culls the blades wholly outside the frame plus 24 px before merging, so the SVG holds 26,551 blade subpaths where it
held 391,449; the page's own subpath count did not move, since the page had dropped them itself). settlement-review
...
water, 0 inside the cluster's hull - before and after; in-view density per 1,000 sq ft blades 4.53 -> 4.61, reeds 3.92 -> 3.78; the
...
## 2026-09-12 (feature 226): the homesteads seated from the site boundary - the layout moved
  ...
  On this map: 19 of 19 seated on the first roll with 1.6 candidates per house (1.3 placer calls); the round
...
## 2026-09-12 (feature 227): the homesteads seated envelope first - the layout moved
  ...
  On this map: 19 of 19 seated (roll attempt 5), 25 placer calls at 3.5 envelope tests each,
  9 rectangle tests per house counting every test against 163 under feature 226, 1.3 candidates per house;
  the front row seated 7 and the ranks behind ran 3 rounds; the nearest house stands 60 px from the field
  outline with 6 within 165; drawn aspect 1.71 - the round shape honored, on the driver's fifth roll (each earlier roll stranded one farmhouse); windbreak 231 clumps, copse 202; 3 of
  19 gardens split. The review of the re-pack follows.
