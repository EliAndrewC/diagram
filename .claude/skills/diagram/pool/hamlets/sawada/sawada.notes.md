...
- windbreak: **194** clumps drawn, **18** off the page
- copse: **155** clumps drawn
- farmhouses: **19**
- farmstead fixtures: bath **9**, coop **14**, pit **7**, privy **14**, woodpile **11**
- notice board at **(2096.6, 2201.1)**, **4** of 19 farmhouses within 250 ft
<!-- /census -->
...
## 2026-09-12 (feature 227): the homesteads seated envelope first - the layout moved
  ...
  On this map: 19 of 19 seated on the first roll, 36 placer calls at 4.5 rectangles each (17 rectangles judged per
  house against 163 under feature 226), 1.9 candidates per house; the front row seated 6 and the
  ranks behind ran 2 rounds; the round shape honored at 1.57. The review of the re-pack follows.
