...
hue is all a reader has to tell the second half of the system from the field's own edge - and at hue 171 it read as a
gray-green boundary line beside the brown bund it runs against. It is a dark slate blue now (`#4F7186`), still two
...
- windbreak: **273** clumps drawn, **27** off the page
- copse: **113** clumps drawn
- farmhouses: **19**
- farmstead fixtures: bath **6**, coop **14**, pit **8**, privy **17**, shrine **1**, woodpile **16**
- notice board at **(1729.4, 1732.4)**, **3** of 19 farmhouses within 250 ft
<!-- /census -->
