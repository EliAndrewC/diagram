...
- windbreak: **163** clumps drawn, **148** off the page
- copse: **5** clumps drawn
- farmhouses: **15**
- farmstead fixtures: bath **1**, coop **6**, manure **4**, privy **10**, shrine **1**, woodpile **11**
- notice board at **(1043.6, 698.8)**, **4** of 15 farmhouses within 250 ft
<!-- /census -->
...
## 2026-09-12 (feature 227): the homesteads seated envelope first - the layout moved
  ...
  On this map: 15 of 15 seated on the first roll, 28 placer calls at 5.1 rectangles each (19 rectangles judged per
  house against 194 under feature 226), 1.9 candidates per house; the front row seated 8 and the
  ranks behind ran 1 round; the crescent honored at 2.95 (2.75 before the rank step took the sun corridor; 1.66 at the first cut). The review of the re-pack follows.
