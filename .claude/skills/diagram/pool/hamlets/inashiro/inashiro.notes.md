...
- windbreak: **163** clumps drawn, **193** off the page
- copse: **82** clumps drawn
- farmhouses: **15**
- farmstead fixtures: bath **6**, coop **11**, manure **4**, privy **8**, shrine **1**, woodpile **11**
- notice board at **(961.8, 838.4)**, **4** of 15 farmhouses within 250 ft
<!-- /census -->
...
## 2026-09-12 (feature 227): the homesteads seated envelope first - the layout moved
  ...
  On this map: 15 of 15 seated (roll attempt 1), 19 placer calls at 2.9 envelope tests each,
  7 rectangle tests per house counting every test against 194 under feature 226, 1.3 candidates per house;
  the front row seated 7 and the ranks behind ran 2 rounds; the nearest house stands 44 px from the field
  outline with 5 within 165; drawn aspect 2.42 - the crescent honored; windbreak 163 clumps, copse 82; 3 of
  15 gardens split. The review of the re-pack follows.
