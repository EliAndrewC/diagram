...
(function () {
  ...
  function open(key) {
    ...
    // THE PRESUMPTION OF ACCURACY (feature 154, GM 2026-08-29). `lead` is empty for everything the
    ...
    // WHAT IS TRUE OF THIS MAP ONLY (feature 154): authored in the settlement's own .notes.md and
    ...
    fillText(caveat, d.caveat ? "On the drawing: " + d.caveat : "");
