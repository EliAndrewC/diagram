...
_DEFS: tuple[FeatureClass, ...] = (
    ...
    FeatureClass(
        ...
        why="A converted district grew no rice, and Fei's silk village grew its vegetables on whatever ground the mulberry left; so the residual parcel of a converted block reads as vegetable ground as honestly as paddy. Three attested states, so each parcel rolls one.",
        label="accurate",
