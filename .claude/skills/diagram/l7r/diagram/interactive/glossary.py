...
GLOSSARY: dict[str, tuple[tuple[str, ...], str]] = {
    ...
    "naya": (("naya",), "A farm outbuilding for storage and work - straw, tools, a threshing floor under a roof."),
    "kura": (("kura",), "A storehouse: the fireproof clay-walled store a better-off household kept for grain and goods."),
    "goemon-buro": (("goemon-buro",), "The cauldron bath: an iron tub heated from below, the bath of self-sufficient farm villages."),
    "kayabuki": (("kayabuki",), "Thatch of miscanthus grass - the steep roof of a farmhouse, pitched at 45 degrees or more so the water runs off."),
    ...
    "azenuri": (("azenuri",), "The spring re-plastering of the paddy bunds with mud so they hold water for the season."),
    "hem": (("hem",), "The band of dry ground above the paddy's supply canal where the dry crops grow."),
    "understory": (("understory",), "The trees and shrubs growing beneath the canopy of a wood, in its shade."),
    "emergent": (("emergent", "emergents"), "A tree whose crown stands above the general canopy of the wood."),
