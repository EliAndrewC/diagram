...
def _seg_0603__paddy_plot_seams_shared(*, M: Any = _UNBOUND, check: Any = _UNBOUND, fields: Any = _UNBOUND) -> dict[str, Any]:
    ...
    # A DIKE-POND IS THE ONE FIELD WHERE TWO RINGS A STRIP APART ARE RIGHT (feature 150, the first
...
def _seg_0614_500__all_ink_is_ruled_on(
    *,
    ...
    tagged is one the registry knows (feature 150, spec FR-009 / SC-006).
