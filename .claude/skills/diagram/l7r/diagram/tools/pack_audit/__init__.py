...
from .registry import checks_for as checks_for
from .registry import run_checks as run_checks
from .report import check_lines as check_lines
...
from .shared import scale_bar_present as scale_bar_present
from .shared import structures_overlap as structures_overlap
from .shared import two_court_zoning as two_court_zoning
from .shared import viewbox_cropped as viewbox_cropped
