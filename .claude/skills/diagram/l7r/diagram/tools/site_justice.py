...
from l7r.diagram.settlement import BOUNDARY_MARKER_FT, BOUNDARY_MARKER_MIN_PX, PUNISHMENT_SPOT_FT, crop_boxes, execution_ground_ft
...
if __name__ == "__main__":  # pragma: no cover - CLI entry
    ...
    guard("l7r.diagram.tools.site_justice")
