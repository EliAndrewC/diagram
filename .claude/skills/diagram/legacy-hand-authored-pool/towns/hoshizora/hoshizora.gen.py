...
s.block_polys.append([(1712, 380), (1800, 380), (1800, 424), (1712, 424)])  # the quarter's NW corner, reserved
# 2026-08-08: the RNG-scope re-roll seated a burakumin house up at (1755,406), close enough to the caste above it
# to read as mixed (burakumin_quarter_segregated). Cropping the pack and shifting it south were both tried first
# and each cost the quarter its budgets.md count band - the corner is the only part that was ever wrong.
...
s.block_polys.append([(192, 522), (244, 522), (244, 574), (192, 574)])  # the RNG-scope re-roll sank a farm wellhead at (217,546) into a paddy (wells_clear_of_paddies); reserve the plot so well_at's _fits refuses it
