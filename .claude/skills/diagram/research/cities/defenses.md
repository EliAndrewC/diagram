...
**Sources:** [`xian-wall-zhwiki`](https://zh.wikipedia.org/wiki/%E8%A5%BF%E5%AE%89%E5%9F%8E%E5%A2%99) (READ: 98 mamian, 20 m wide, projecting 12 m; the wall 12 m high, base 15-18 m, TOP 12-14 m - the "top 15 m" some prose carries is not this source's figure). The guard-room and gate-tower bay estimates were not re-sourced - leftover
...
**Sources:** [`hakone-seki-jawiki`](https://ja.wikipedia.org/wiki/%E7%AE%B1%E6%A0%B9%E9%96%A2) (READ: the 面番所 and 向番所 lists; that they stand opposite each other across the road is SUMMARY-ONLY), [`wengcheng-zhwiki`](https://zh.wikipedia.org/wiki/%E7%93%AE%E5%9F%8E) (READ: the barbican). Lijin / chaoguan barrier practice not re-sourced - leftover [`chaoguan-zhwiki`](https://zh.wikipedia.org/wiki/鈔關) (READ - scope correction below)
...
*Correction to the record (2026-08-28, feature 143):* the Ming-Qing 鈔關 customs barriers stood at commodity centers and on the Grand Canal and strategic routes, not at a county seat's gates; lijin is a separate, later Qing tax. The gate-throat cluster rests on the Hakone sekisho arrangement (SUMMARY-ONLY) and the chokepoint reasoning, not on Chinese customs practice.
...
**Sources:** [`shen-kuo`](https://zh.wikipedia.org/wiki/%E4%B8%87%E6%98%A5%E5%9C%A9)
