...
**Sources:** [`kyomachiya-jawiki`](https://ja.wikipedia.org/wiki/%E4%BA%AC%E7%94%BA%E5%AE%B6), [`kyototuu-unagi`](https://www.kyototuu.jp/Life/ProverbUnaginoNedoko.html), [`nagaya-jawiki`](https://ja.wikipedia.org/wiki/%E9%95%B7%E5%B1%8B) (READ). Chinese county-seat party-wall housing not re-sourced - leftover
...
*Correction to the record (2026-08-28, feature 143):* "street frontage was taxed" is the popular explanation of the narrow lot ([`kyototuu-unagi`](https://www.kyototuu.jp/Life/ProverbUnaginoNedoko.html) carries it), and [ja.wikipedia 京町家](https://ja.wikipedia.org/wiki/%E4%BA%AC%E7%94%BA%E5%AE%B6) disputes it outright - Edo-period Kyoto assessed a lump sum per town, not per frontage. The continuous built edge is read either way; the tax is not the reason to cite.

## Machiya row density: a commercial street is a continuous built edge

**Evidence:** attested

**Sources:** [`kyototuu-unagi`](https://www.kyototuu.jp/Life/ProverbUnaginoNedoko.html) (READ: frontage ~2 ken, depth 10-12 ken), [`kyomachiya-jawiki`](https://ja.wikipedia.org/wiki/%E4%BA%AC%E7%94%BA%E5%AE%B6), [`hiyokechi-jawiki`](https://ja.wikipedia.org/wiki/%E7%81%AB%E9%99%A4%E5%9C%B0) (READ: breaks at block scale after 1657). See the frontage-tax correction in the entry above
...
**Sources:** [`chang-morphology-walled-capitals`](http://web.stanford.edu/~mel1000/sen.pdf); specs/009-city-area-budget/research.md section B (Quanzhou a quarter vacant in 1945, Suzhou's intramural farmland, Jinan's lake, Pingyao's "4 big streets, 8 small streets, 72 lanes") - recorded at the 2026-07 pass, not re-read 2026-08-28
