...
**Sources:** `yato-jawiki`, `shitsuden-kotobank`, `hibiya-irie-jawiki` (READ). Reed beds under iriai specifically, fukada persisting to Meiji, Suzhou's canal grid and the night-soil vegetable belt not re-read - leftover
