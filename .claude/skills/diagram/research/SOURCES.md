...
The 1987 survey of Kashima, Tonami plain (kainyo homestead groves) - SUMMARY-ONLY: the pointer was not recorded at the 2026-07 pass and is to be re-found (ja.wikipedia 屋敷林 / カイニョ cite the survey literature) URL: none - not found 2026-08-28: Searched Japanese terms (砺波 鹿島 1987 屋敷林 カイニョ 調査); found only the 2014 J-STAGE etymology paper and Tonami city surveys, no 1987 Kashima survey pointer.
...
The 1581 (万历九年) fishpond figures for the Pearl delta - SUMMARY-ONLY (2026-08-28): a search synthesis gives ~160,000 mu of taxable fishponds across Shunde, Nanhai and Panyu (Guangzhou prefecture), ~400,000 mu of dike-pond farming; the Shunde county figures (40,084 mu in 1581, 58,094 in 1642) were seen in a search snippet of a Shunde library page and not on a page read; the county percentage and the 1980s 35% survey were found nowhere. baike.baidu.com (403) is the likely carrier URL: none - not found 2026-08-28: Search snippet of a ScienceNet blog (明代广东农村的桑基鱼塘) gives 159,828 mu in 1581 and 58,094 mu in 1642, but both blog URLs fetched as empty shells; zh.wikipedia 顺德县 l
