...
*Correction to the record (2026-08-28, feature 138):* "the igune ... ran dense/multi-row/evergreen-heavy" - the page read names three evergreen conifers and one deciduous broadleaf (keyaki) and never characterizes the mix; the north-and-west placement against the winter wind is read. Softened to "conifer-dominated, with keyaki"; the rule (a dense full-height belt, distinct from pollarded dike willows) is unaffected.
