...
**Grounds:** `build_polder(mosaic=)`; `pond_layout` as a twin axis (a rolled hamletgen knob since feature 134)
...
**Grounds:** the drawn bank width; `_mulberry_rows` crown density; `POLDER_FABRIC` (feature 134)
...
## What stands on a dike-pond hamlet that a paddy hamlet lacks - the audit (feature 134, 2026-08-28)

**Grounds:** the feature-134 audit list (`specs/134-kuwabata-dike-pond-hamlet/audit.md`); nothing drawn from it yet - the GM chooses (FR-008)
...
- **Boats, and a village laid out along its water.** *"Nearly every household possesses one or more boats except those who are not engaged in agricultural or fishing work."* *"The importance of the boat in communication means that the houses must be near the water and consequently determines the plan of the village. Villages grow up along the streams."* *"Every village has its own agent boat which serves as the buying and selling agent of the villagers in the town market."* The Pearl-delta proverb of the Sangyuanwei polder says the same of silk: 一船蚕丝出，一船白银归 - *a boat of silk out, a boat of silver back*. A cash-crop hamlet that sells silk and fish and buys grain in is a hamlet that LIVES by water transport. Kuwabata as generated has a header reservoir and a ring canal and no navigable water at all - the market link its own notes say is implied is not on the sheet. CANDIDATE: a creek or navigable channel along the landward flank with household boats moored at it (a sampan ~15-20 ft x 4 ft, drawable at 1 ft/px; a boat is furniture, not fauna, under the no-fauna rule), and a landing. A NEW CATEGORY (water, boats, a landing) - the GM's call.
...
*Departures and honesty.* Fei is Lake Tai, 1936; the Pearl-delta reads are 1980s surveys and a 2006 summary of the 1988 monograph, which itself could not be fetched (403 on every host) - every Ruddle & Zhong number here is SUMMARY-ONLY. No single source describes a WHOLLY converted hamlet's farmsteads; the list is assembled across the two systems and says so per item.
