...
**Sources:** the lotus area share (a few percent to 10-15%) was found nowhere on 2026-08-28 ([zh.wikipedia 莲藕](https://zh.wikipedia.org/wiki/莲藕) silent; a provincial share of aquatic-vegetable OUTPUT is the nearest figure) - the interpolation stands as a guess and is labeled one; the liberty is the GM's (2026-07-19)
...
**Sources:** [`fortune-1843`](https://www.gutenberg.org/ebooks/54720)
...
**Sources:** [`buck-survey`](https://archive.org/details/landutilizationi0000buck)

The research upheld the instinct: the surveyed rectilinear chessboard of the Taihu *tangpu* 塘浦 system was the CANAL grid at kilometer scale, while the parcels inside it were a private-tenure patchwork - mid-Qing Jiangnan farms averaged ~10 mu scattered over several parcels; [Buck](https://archive.org/details/landutilizationi0000buck)'s pre-mechanization survey (1929-33) found a mean parcel of ~1 mu, rectangular only where it fronted a straight ditch; dike-ponds accreted household-by-household (挖塘培基, research.md D2), so 66 identical ponds contradict the map's own backstory. Uniform machine-sized rectangles are a 20th-century consolidation look (Japan's 1963 *hojo seibi* 30m x 100m standard; PRC consolidation campaigns).
...
**Sources:** [`sdlib-shunde-jitang`](https://www.sdlib.com.cn/home/article/detail/id/741.html) (READ: the dike as pond spoil, planted), [`miragenews-polders`](https://www.miragenews.com/chinas-water-heritage-significance-of-polders-955573/) (READ: fish-scale polders named for their aerial outlines; organic forms replaced by standardized rectangles after 1949)
...
**Sources:** [`willow-palisade`](https://baike.baidu.com/en/item/Willow%20Palisade/1480401)
...
**Sources:** [`usu-windbreak`](https://extension.usu.edu/forestry/publications/utah-forest-facts/005-windbreak-benefits-and-design) (READ: shelter up to 30 H - the entry's 10-20 H is inside it), [`yashikirin-jawiki`](https://ja.wikipedia.org/wiki/屋敷林) (READ: igune on the north and west; species スギ・マツ・ヒノキ・ケヤキ)
...
**Sources:** [`cssn-jiangnan-weitian`](https://cssn.cn/lsx/lsx_zgs/202502/t20250217_5844872.shtml) (READ: "中有河渠，外有门闸" - channels inside the dike, gates through it, opened in drought and shut in flood). The 一河围田 shorthand, the inside-toe placement and the 月样 / 弓样 forms were not found on any page read (zh.wikipedia 圩田 silent) - leftover [`weinei-he-summary`](SOURCES.md#weinei-he-summary) (SUMMARY-ONLY: the 月状 / 弓状 forms and gated ends)
...
**Sources:** [`fusekoshi-jawiki`](https://ja.wikipedia.org/wiki/伏越) (READ: the inverted siphon under a watercourse, with historical examples), [`suirokyo-jawiki`](https://ja.wikipedia.org/wiki/水路橋) (READ: the aqueduct bridge)
...
**Sources:** [`mdpi-3860`](SOURCES.md#mdpi-3860) (SUMMARY-ONLY - 403 in the 2026-08-28 re-sourcing pass), [`shen-kuo`](https://zh.wikipedia.org/wiki/%E4%B8%87%E6%98%A5%E5%9C%A9) for the surveyed wei-tian
**Sources:** [`cssn-jiangnan-weitian`](https://cssn.cn/lsx/lsx_zgs/202502/t20250217_5844872.shtml) (READ: the tangpu lattice at five-to-seven and seven-to-ten li), [`miragenews-polders`](https://www.miragenews.com/chinas-water-heritage-significance-of-polders-955573/) (READ). The Pearl-delta "mosaic-like ... boundary blurred" description and the dikes eroded from ~20 m to under 4 m: MDPI *Forests* 13(8):1241 and *Aquaculture* 2022 (both 403) - SUMMARY-ONLY, leftover [`dikepond-erosion-summary`](SOURCES.md#dikepond-erosion-summary) (SUMMARY-ONLY: ponds grew, dikes shrank 1967-2016)
...
**Sources:** [`gd-gazetteer-sangji`](https://dfz.gd.gov.cn/index/dqyj/content/post_4237091.html) (水基比 三七至四六开), [`fao-ac241e`](https://www.fao.org/4/ac241e/ac241e00.htm) (6:4; 1:1 where the worms alone feed the fish), [`isis-dykepond`](https://www.i-sis.org.uk/DykePondSystem.php) carrying [`ruddle-zhong-1988`](SOURCES.md#ruddle-zhong-1988) SUMMARY-ONLY for the 0.4-0.6 ha ponds and 6-10 m dikes. The coppiced-bush density (one bush per 10-20 sq ft, crowns 4-6 ft) was NOT re-found on 2026-08-28 - it stays on the re-sourcing queue
...
**Sources:** [`cssn-sangji-yutang`](https://www.cssn.cn/ztzl/jzz/rwln/wh/lnfw1/202209/t20220923_5541481.shtml) (READ: "基六塘四"), [`kuwa-jawiki`](https://ja.wikipedia.org/wiki/クワ) (READ: mulberry kept as a low shrub; the height and density SUMMARY-ONLY)
...
*Correction to the record (2026-08-28, feature 143) - CONTRADICTED on the ORDER of the ratio, rule unchanged, awaiting the GM:* the one page read writes the classic prescription as **基六塘四 - six parts DIKE to four parts POND**; the entry (and a people.cn page seen only in a search summary, "六分为塘，四分为基") has it the other way, six water to four dike, and Kuwabata is drawn at 76% water per parcel. The literature carries both orders and a 7:3 variant, so this may be a regional split rather than an error - but as the record stands, the drawn ratio rests on the reading the read source inverts. Listed in the feature 143 ledger, section G, with the option of a follow-up read ([Ruddle & Zhong 1988](SOURCES.md#ruddle-zhong-1988) is the authority) before any redraw.

**GM ruling (2026-08-28, feature 143 T20) - DEVIATION, disclosed regional reading:** Kuwabata keeps its 6 water : 4 dike parcels. The record carries the prescription in BOTH orders - 基六塘四 on the page read ([`cssn-sangji-yutang`](https://www.cssn.cn/ztzl/jzz/rwln/wh/lnfw1/202209/t20220923_5541481.shtml)), 六分为塘、四分为基 in the people.cn summary - and a 7:3 variant; the map follows the water-heavy reading. The interactive map is to say so on every pond and bank of Kuwabata: "a regional reading; the classic prescription is also recorded as six parts dike to four parts pond". Class for the HTML modal: **deviation** (a priced trade-off, not an error).
...
**Sources:** [`fao-x6708e`](https://www.fao.org/fishery/docs/CDrom/FAO_Training/FAO_Training/General/x6708e/x6708e10.htm) (the sluice-gate definition, verbatim, READ 2026-08-28), [`cssn-sangyuanwei`](https://www.cssn.cn/ztzl/jzz/rwln/wh/lnfw/202209/t20220923_5541513.shtml) (the polder's 窦)
**Sources:** [`cssn-jiangnan-weitian`](https://cssn.cn/lsx/lsx_zgs/202502/t20250217_5844872.shtml) (READ: gates through the dike, worked by season - the polder case); the pond sluice "closed with wooden boards" and the inlet-high / outlet-low plumbing come from [Ruddle & Zhong](SOURCES.md#ruddle-zhong-1988) (Cambridge 1988; GeoJournal BF00645312 login-walled) and were not re-read: SUMMARY-ONLY - leftover
...
**Sources:** [`fei-1939`](https://archive.org/details/in.ernet.dli.2015.76327), [`fao-ac264e`](https://www.fao.org/4/ac264e/ac264e09.htm), [`fao-ac241e`](https://www.fao.org/4/ac241e/ac241e00.htm), [`isis-dykepond`](https://www.i-sis.org.uk/DykePondSystem.php) (carrying [`ruddle-zhong-1988`](SOURCES.md#ruddle-zhong-1988), SUMMARY-ONLY), [`cssn-sangyuanwei`](https://www.cssn.cn/ztzl/jzz/rwln/wh/lnfw/202209/t20220923_5541513.shtml), [`miles-2003`](SOURCES.md#miles-2003) (SUMMARY-ONLY), [`gmrb-2024-sangji`](https://epaper.gmw.cn/gmrb/html/2024-03/19/nw.D110000gmrb_20240319_7-01.htm), [`dili360-2005-sangji`](https://www.dili360.com/cng/article/p5350c3d7e437f08.htm)
...
枝郷](https://ja.wikipedia.org/wiki/%E6%9E%9D%E9%83%B7), READ - 「もとの村を本郷（本郷、元郷、親郷、親村、本村）とよぶのに対し、新村を枝郷（枝村、子村）と称した」
and 「多くの場合、本郷の庄屋・名主から村高が分け与えられていた」. [The National Diet Library's reference
service](https://crd.ndl.go.jp/reference/entry/index.php?id=1000166660&page=ref_view) gives the fiscal half, READ: 「年貢の賦課徴収では検地帳・年貢免定は親村の名義で、小村の年貢納入は
...
count or share of any settlement form; a J-STAGE study of Kishu (URL not found 2026-09-06) shows only that multi-hamlet
...
like evidence and is not - [en.wikipedia](https://en.wikipedia.org/wiki/Kokudaka), READ: "The amount of taxation was not based on the actual
...
households)". The nearest historical figure the pass could reach was [Kinoshita 1995](SOURCES.md#kinoshita-1995) at summary level
...
**Sources:** [`edago-ja`](https://ja.wikipedia.org/wiki/%E6%9E%9D%E9%83%B7) (READ), [`ndl-hongo-edago`](https://crd.ndl.go.jp/reference/entry/index.php?id=1000166660&page=ref_view) (READ), [`jstage-admin-natural-village`](https://www.jstage.jst.go.jp/article/jjhg1948/19/2/19_2_117/_article) (READ, abstract level), [`kokudaka-en`](https://en.wikipedia.org/wiki/Kokudaka) (READ - cited for what it does NOT establish), [`nanushi-en`](https://en.wikipedia.org/wiki/Nanushi) (READ, does not resolve the branch/parent question), [`kinoshita-1995`](SOURCES.md#kinoshita-1995) (SUMMARY-ONLY - 403 on one attempt), [`hayami-encyclopedia`](https://www.encyclopedia.com/social-sciences/encyclopedias-almanacs-transcripts-and-maps/hayami-akira) (READ, no absolute figure), [`l7r-median-domain`](SOURCES.md#l7r-median-domain) (the setting's own canon, which decides where history is silent)
