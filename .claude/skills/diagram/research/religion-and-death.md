...
**Evidence:** liberty (the L7R over-sizing), researched (the historical counts - not confirmed)

**Sources:** [`religion-song-enwiki`](https://en.wikipedia.org/wiki/Religion_in_the_Song_dynasty) (READ: 1221, 400,000 monks and 61,000 nuns); the "90,000+ Edo temples" and the Shaolin / Daxiangguo counts were found in no page read (adeac.jp Sapporo library page delivered no body; [ja.wikipedia 寺請制度](https://ja.wikipedia.org/wiki/寺請制度) gives only 6,000 Jōdo temples in 1696) - leftover [`daxiangguo-enwiki`](https://en.wikipedia.org/wiki/Daxiangguo_Temple) (READ: "several thousand" monks - more than the 1,000+ recorded)
...
**Sources:** [`kanazawa-teramachi`](https://visitkanazawa.jp/en/spot/detail_10182.html), [`takada-teramachi`](https://joetsu-stories.jp/2025/02/03/takada-teramachi-part-1/), [`takayama-teramachi`](https://en.japantravel.com/gifu/takayama-s-teramachi-gifu/13893), [`jokamachi-wiki`](https://www.japanesewiki.com/history/Jokamachi.html), [`pingyao-chenghuangmiao`](https://en.wikipedia.org/wiki/City_God_Temple_of_Pingyao)
...
**Sources:** [`chinaknowledge-tang-econ`](SOURCES.md#chinaknowledge-tang-econ), [`inexhaustible-treasuries`](SOURCES.md#inexhaustible-treasuries), [`tontine-monastery-lending`](https://tontinecoffeehouse.com/2024/02/26/buddhist-monastery-lending/), [`pawnbroking-history`](https://en.wikipedia.org/wiki/History_of_pawnbroking), [`zhengyi-householder-priests`](SOURCES.md#zhengyi-householder-priests), [`kannushi-wiki`](https://en.wikipedia.org/wiki/Kannushi), [`jodo-shinshu-marriage`](https://seattlebetsuin.org/jodo-shinshu-and-marriage/), [`tricycle-temple-wives`](https://tricycle.org/magazine/japan-temple-wives/)
...
**Sources:** reasoning from the funerary doctrine (`../settlements/religion-and-death.md`) and the Fox precincts' canon - a decision to REJECT a change, nothing physical re-sourced (research: rendering)
...
**Evidence:** attested (Fushimi), reconstruction (the distribution shape)

**Sources:** [`fushimi-inari-senbon`](https://inari.jp/sp/map/spot_07/) (READ: ~10,000 on the mountain, ~800 in the Senbon Torii, donated from Edo into Meiji). The "~600 in Meiji" figure was not on the NDL reference page read; the 1 / 2-3 / dozens distribution is assembled from normative statements, as the entry says - no census exists
