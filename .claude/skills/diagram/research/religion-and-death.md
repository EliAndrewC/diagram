...
**Sources:** `religion-song-enwiki` (READ: 1221, 400,000 monks and 61,000 nuns); the "90,000+ Edo temples" and the Shaolin / Daxiangguo counts were found in no page read (adeac.jp Sapporo library page delivered no body; ja.wikipedia 寺請制度 gives only 6,000 Jōdo temples in 1696) - leftover
...
**Sources:** `louzeyuan-zhwiki` (READ: 1104, high barren ground, fenced, numbered plots, continued through Ming), `toribeno-jawiki` (READ: no defined boundary). Adashino, Rendaino and Osaka's seven graveyards (大坂七墓 page 404) not re-read - leftover
