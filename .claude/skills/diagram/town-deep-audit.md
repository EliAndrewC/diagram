...
**Sources (feature 143, 2026-08-28):** a dated audit; its external research is listed in section 8 below (Izumida on machiya, JAANUS on hinomi-yagura, the hatago counts, the Edo pawnshop count, Takayama Jin'ya) and the findings it fed are now cited in `research/urban-features.html` and `research/cities/fabric.html`.
